...
struct HelpView: View {
    var body: some View {
        List {
            ...
            row("Practice", "You return to it. It is never done. “20 minutes on solo X.” Everyday, weekdays, weekends, every 3 days, or weekly.")
            row("Cue", "When a quest or practice may surface. For a practice, how often. Not an alarm.")
            row("Today", "The quests and practices that fit this day. The date ticks with the phone’s clock. Quests, practice, or when. Swipe right or tap to mark one done. A quest leaves. A practice comes back when its cue allows. Paths live on the other tab.")
