...
struct HelpView: View {
    var body: some View {
        PixelList {
            ...
            row("Routine", "You return to it. It is never done. “20 minutes on solo X.” Everyday, weekdays, weekends, every 3 days, weekly, or monthly on a chosen day. Shorter months use their last day.")
