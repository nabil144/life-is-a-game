...
struct HelpView: View {
    var body: some View {
        List {
            ...
            row("Today", "The quests and practices that fit this day. The date ticks with the phone’s clock. Quests, practice, path, or when. Swipe right to mark one done, or tap to confirm on that row. A quest leaves. A practice comes back when its cue allows. Paths live on the other tab.")
