...
|---|---|---|---|
| Today | Quests and practices due today. Live date and time pin above the sort; both stay while scrolling and the date shrinks. Quests, Practice, Path, or When. Swipe right to mark done, or tap the row to confirm on that row. Glyph opens the path. | Tab, notification tap | Path detail, Capture |
