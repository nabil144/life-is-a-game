...
|---|---|---|---|
| Today | Quests and practices due today. Swipe right to mark done, or tap the row to confirm on that row. Glyph opens the path. | Tab, notification tap | Path detail, Capture |
